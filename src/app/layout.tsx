        ...
        <Script id="mermaid-init" strategy="afterInteractive" dangerouslySetInnerHTML={{ __html: `
          (function checkMermaid(attempts) {
            if (typeof mermaid !== 'undefined') {
              mermaid.initialize({ startOnLoad: false, theme: 'dark', flowchart: { wrappingWidth: 300, useMaxWidth: true }, themeVariables: { primaryColor: '#1a3a1a', primaryTextColor: '#00ff41', primaryBorderColor: '#00ff41', lineColor: '#00ff41', secondaryColor: '#1a1a2e', tertiaryColor: '#0a0a0a', fontFamily: 'monospace' } });
            } else if (attempts < 50) {
